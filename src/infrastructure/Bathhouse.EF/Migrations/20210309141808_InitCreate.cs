        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeOfClose = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkItems_Employees_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkItems_Employees_ExecutorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SurveyResults_Employees_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Answers_SurveyResults_ResultId",
                        column: x => x.ResultId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0f391520-9cef-4a9a-8355-a876a16b59bd"), "93b722a7-2b94-4b2f-95c2-e95a84dff0f4", "Admin", "ADMIN" },
                    { new Guid("63e3e8e8-eb69-4eb9-8a34-2d5ce69e5c8e"), "4aa1eeeb-0674-490f-bc49-b06f45072d1c", "Director", "DIRECTOR" },
                    { new Guid("277216cb-ed9a-450f-b651-db0a182a0038"), "0a1a1c07-9fd0-4b10-b9ab-34f6f412f5bd", "Manager", "MANAGER" },
                    { new Guid("8e6ba617-2dcf-4fdf-93be-d0eda7ca0863"), "605d975b-968a-4651-b050-34cf8de0ff4a", "Employee", "EMPLOYEE" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyResults_AuthorId",
                table: "SurveyResults",
                column: "AuthorId");
